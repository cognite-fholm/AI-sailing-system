...
|------|--------|--------|-----|
| [`../7710 (3).slk`](../../7710%20(3).slk) | Own boat **Xbox** (ORC CertNo 7710) | SYLK / SLK | Matches [ORC Certificate for Xbox.pdf](../../ORC%20Certificate%20for%20Xbox.pdf) |
| [`../off_course.png`](../../off_course.png) | OFF COURSE (NOR 15788) | ORC certificate image | Competitor polar — `polar-certificate-extractor` |
| [`../ORC Certificate for Xbox.pdf`](../../ORC%20Certificate%20for%20Xbox.pdf) | **Xbox** (NOR 10133) | ORC certificate | Own-boat handicaps + polar lineage (CertNo 7710) |
| [`../ORC Certificate for Off Course.pdf`](../../ORC%20Certificate%20for%20Off%20Course.pdf) | OFF COURSE (NOR 15788) | ORC certificate PDF | Competitor handicaps + polar |
...
- [`config/data-repo.yaml`](../config/data-repo.yaml) — link to **AI-sailing-data** repo
