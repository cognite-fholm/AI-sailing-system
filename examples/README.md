...
| [`../Seilingsbestemmelser_Færderseilasen26_2.pdf`](../../Seilingsbestemmelser_F%C3%A6rderseilasen26_2.pdf) | Færderseilasen 2026 | SI PDF §11 | Course routes — `course-parser` |

Configured in:

- [`config/vessel.yaml`](../config/vessel.yaml)
- [`config/competitors.yaml`](../config/competitors.yaml)
- [`config/courses.yaml`](../config/courses.yaml)
- [`config/handicaps.yaml`](../config/handicaps.yaml)

See [spec.md §7.12.3](../spec.md#7123-polar-diagram-management), [§7.13](../spec.md#713-race-courses-waypoints--live-results), and [§7.14](../spec.md#714-handicap-numbers--scoring).
