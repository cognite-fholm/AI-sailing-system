...
echo "Next: ./scripts/harbor-prepare.sh"
echo "(Alternative: ./scripts/render-secrets-env.sh && python deploy/secrets/check_secrets.py --secrets-dir /opt/ai-sailing-system/secrets)"
